...
str1 = 'ei_with_prior_without_googlenet.txt'
str2 = 'test_without_googlenet.txt'
fout1 = open("ei_accuracy1.txt",'w')



str3 = 'ei_without_without_googlenet.txt'
str4 = 'test_without_googlenet.txt'
fout2 = open("ei_accuracy2.txt",'w')


str5 = 'ei_with_with.txt'
str6 = 'test_second.txt'
fout3 = open("ei_accuracy3.txt",'w')

str7 = 'ei_without_prior_with_googlenet.txt'
str8 = 'test_second.txt'
fout4 = open("ei_accuracy4.txt",'w')
